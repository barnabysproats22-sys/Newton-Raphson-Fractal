...
public class Complex {
     ...
     */
    public double abs() {
        return Math.sqrt(x*x + y*y); //Maybe Math.sqrt(abs2()) or soemthing?
    }
    ...
    public Complex divide(Complex b) {
        return new Complex((1/b.abs2())*(x*b.x + y*b.y)  ,  (1/b.abs2())*(y*b.x - x*b.y )); //Returns Scaled Complex Number
    }
	...
	//Own Testing
    Complex P = new Complex(-0.4999999999999555,0.8660254037846933);
    Complex Q = new Complex(-0.4999999113699129,0.8660249031568892);
    System.out.println("Q: " + Q);
    System.out.println("P: " + P);
    //System.out.println(P.add(Q.minus()));
    System.out.println((P.add(Q.minus())).abs());
    }
}
